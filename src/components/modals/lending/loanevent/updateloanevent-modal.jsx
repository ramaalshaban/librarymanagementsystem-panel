...
export default function LendingUpdateLoanEventModal({
  openDialog,
  selectedLoanEvent,
}) {
  ...
  const requestParams = [
    { name: "note", value: selectedLoanEvent?.note ?? "", type: "Text" },
  ];

  const defaultValues = {
    note: selectedLoanEvent?.note ?? "",
  };
  ...
  if (!selectedLoanEvent) return null;

  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Update LoanEvent</DialogTitle>
