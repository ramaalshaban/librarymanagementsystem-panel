...
export default function CatalogInventoryUpdateBranchInventoryModal({
  openDialog,
  ...
  const requestParams = [
    {
      name: "totalCopies",
      value: selectedBranchInventory?.totalCopies ?? "",
      type: "Integer",
    },

    {
      name: "availableCopies",
      value: selectedBranchInventory?.availableCopies ?? "",
      type: "Integer",
    },

    {
      name: "localShelfLocation",
      value: selectedBranchInventory?.localShelfLocation ?? "",
      type: "String",
    },

    {
      name: "conditionNotes",
      value: selectedBranchInventory?.conditionNotes ?? "",
      type: "Text",
    },
  ];

  const defaultValues = {
    totalCopies: selectedBranchInventory?.totalCopies ?? "",

    availableCopies: selectedBranchInventory?.availableCopies ?? "",

    localShelfLocation: selectedBranchInventory?.localShelfLocation ?? "",

    conditionNotes: selectedBranchInventory?.conditionNotes ?? "",
  };
  ...
  if (!selectedBranchInventory) return null;

  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Update BranchInventory</DialogTitle>
