...
export default function CatalogInventoryDeletePurchaseOrderModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete PurchaseOrder</DialogTitle>
      <DialogContent>
        do you want to delete the purchaseOrder with id: {selectedId}
      </DialogContent>
