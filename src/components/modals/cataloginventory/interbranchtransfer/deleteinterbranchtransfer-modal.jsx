...
export default function CatalogInventoryDeleteInterBranchTransferModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete InterBranchTransfer</DialogTitle>
      <DialogContent>
        do you want to delete the interBranchTransfer with id: {selectedId}
      </DialogContent>
