...
export default function ReviewEngagementDeleteEngagementEventModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete EngagementEvent</DialogTitle>
      <DialogContent>
        do you want to delete the engagementEvent with id: {selectedId}
      </DialogContent>
