...
export default function AdminOpsDeleteBranchStaffAssignmentModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete BranchStaffAssignment</DialogTitle>
      <DialogContent>
        do you want to delete the branchStaffAssignment with id: {selectedId}
      </DialogContent>
