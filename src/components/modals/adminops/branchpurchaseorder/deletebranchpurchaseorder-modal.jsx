...
export default function AdminOpsDeleteBranchPurchaseOrderModal({
  openDialog,
  selectedId,
}) {
  ...
  return (
    <Dialog open={openDialog.value} maxWidth="md">
      <DialogTitle>Delete BranchPurchaseOrder</DialogTitle>
      <DialogContent>
        do you want to delete the branchPurchaseOrder with id: {selectedId}
      </DialogContent>
