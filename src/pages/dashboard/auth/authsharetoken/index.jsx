...
const metadata = {
  title: `AuthShareToken data - Auth module - ${CONFIG.appName}`,
};

export default function AuthAuthShareTokenAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "AuthShareToken");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listauthShareTokens");
