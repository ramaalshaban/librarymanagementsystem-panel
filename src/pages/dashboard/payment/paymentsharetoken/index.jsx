...
const metadata = {
  title: `PaymentShareToken data - Payment module - ${CONFIG.appName}`,
};

export default function PaymentPaymentShareTokenAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "PaymentShareToken");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listpaymentShareTokens");
