...
const metadata = {
  title: `AdminOpsShareToken data - AdminOps module - ${CONFIG.appName}`,
};

export default function AdminOpsAdminOpsShareTokenAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "AdminOpsShareToken");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listadminOpsShareTokens");
