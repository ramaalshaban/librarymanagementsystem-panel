...
const metadata = {
  title: `LendingShareToken data - Lending module - ${CONFIG.appName}`,
};

export default function LendingLendingShareTokenAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "LendingShareToken");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listlendingShareTokens");
