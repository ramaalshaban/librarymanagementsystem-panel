...
export default function LendingUpdateReservationApiPage() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      setUpdatedReservation(response.data.reservation);
    } catch (ex) {
      console.error(ex);
      setError(ex);
    }
    ...
    <Form methods={methods} onSubmit={onSubmit}>
      ...
      {(updatedReservation || error) && (
        <Box paddingTop="2rem">
          ...
          <Box>
            {view === "Table" ? (
              <TableResponse content={updatedReservation} error={error} />
            ) : (
              <JsonResponse content={updatedReservation || error} />
            )}
          </Box>
        </Box>
      )}
