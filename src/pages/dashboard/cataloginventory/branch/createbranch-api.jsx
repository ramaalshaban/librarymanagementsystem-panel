...
export default function CatalogInventoryCreateBranchApiPage() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const response = await catalogInventoryAxios.post(
        catalogInventoryEndpoints.branch.createBranch,
        data,
      );
      setError(null);
    ...
    <Form methods={methods} onSubmit={onSubmit}>
      ...
      {(createdBranch || error) && (
        <Box paddingTop="2rem">
          ...
          <Box>
            {view === "Table" ? (
              <TableResponse content={createdBranch} error={error} />
            ) : (
              <JsonResponse content={createdBranch || error} />
            )}
          </Box>
        </Box>
      )}
