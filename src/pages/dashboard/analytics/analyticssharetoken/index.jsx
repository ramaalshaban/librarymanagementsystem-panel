...
const metadata = {
  title: `AnalyticsShareToken data - Analytics module - ${CONFIG.appName}`,
};

export default function AnalyticsAnalyticsShareTokenAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "AnalyticsShareToken");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listanalyticsShareTokens");
